...
require("../common/common.inc"); common_header(); ?>
	...
	<ul>
	<li>Already In Linux Kernel</li>
	<li>Impact On File Systems</li>
	<li>Impact On Users And Host Systems</li>
	<li>Aggregating Storage</li>
	<li>Dynamically Increasing Storage</li>
	<li>New Cost Model</li>
	<li>Performance Variables</li>
