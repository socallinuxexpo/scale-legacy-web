...
require("../common/common.inc"); common_header(); ?>
	...
	<p>
	<!--
	<img src="/past/2006/images/speakers/winstead.jpg"
		width="150" height="200" alt="Andi Gutmas" class="floatimgright" />
		//-->
	...
	<h3>A Look at the Current and Future Face of PHP</h3>

	<p>
	During the last 10 years, PHP has gained significant momentum with now more than 22 million Web domains running PHP. The open source web language has now reached the point of maturity where organizations are seeking standard tools and solutions that will further facilitate application development with PHP.<br /><br />
