...
require("../common/common.inc"); common_header(); ?>
	...
	<p>
	Tim Jones is the president and chief technology officer of the <a href="http://www.tolisgroup.com">TOLIS
	Group</a>, Inc., the developer of the BRU brand of data backup and recovery
	...
	the sponsor of the <a href="http://www.linuxtapecert.org/">Linux Tape Device Certification Program</a>.<br /><br />
	</p>

	<h3>10 pounds of backup in a 5 pound window - Improving Backup Planning for Growing Environments</h3>
	...
	off-site storage planning becomes more important.<br /><br />
	...
	<ul>
	<li>Full vs. Incremental vs. Differential Backups</li>
	<li>Using Multiple Servers/Tape drives</li>
	<li>Using Libraries with Multiple Drives</li>
	<li>Using Disk to Disk and Disk to Disk to Tape</li>
	<li>Using new Virtual Tape Libraries</li>
	...
	<h3>Resources</h3>
	<ul>
	<li><a href="/past/2005/presentations/tim_jones_scale3x.pdf">Presentation Slides [PDF]</a></li>
