...
require("/home/webroot/common/common.inc"); common_header(); ?>
	...
	<h3>Jon "maddog" Hall</h3>
	<p>
	<img SRC="/images/speakers/maddog.jpg" WIDTH="150" HEIGHT="200"
	                ALIGN="LEFT" hspace="10" BORDER="0" ALT="Jon Hall">
	Jon "maddog" Hall is the Executive Director of Linux International
	(<a href="http://www.li.org">www.li.org</a>), a non-profit association
	...
	hidden cost that keeps them from moving forward.<br /><br />
	This talk explains how the use of FOSS may help propell so-called
