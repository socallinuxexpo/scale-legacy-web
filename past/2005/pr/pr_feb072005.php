...
require("../common/common.inc"); common_header(); ?>
	...
	<a href="http://www-1.ibm.com/servers/eserver/openpower/hardware/710.html">http://www-1.ibm.com/servers/eserver/openpower/hardware/710.html</a>
	</p>
	...
	<p>
	For more information about IBM and their Linux offerings see: <a href="http://linux.ibm.com">http://linux.ibm.com/</a>  or meet their representatives at booth #38 at the Southern California Linux Expo.
	</p>

	<p>
	About the Southern California Linux Expo:<br><br>

	The Southern California Linux Expo is the premier grass roots Linux and Open Source Software conference in the United States.  SCALE 3x their 3rd annual event will be held on February 12th and 13th 2005 at the Los Angeles Convention Center.  SCALE includes seminars by well-known speakers, tutorials for beginners, and an exhibit hall with both vendor booths and non-commercial booths.<br><br>
	...
	Press  Contact:<br>
	Orv Beach<br>
	info=at=socallinuxexpo.org<br><br>

	Sponsorship contact:<br>
	Ilan Rabionvitch<br>
	ilan=at=socallinuxexpo.org<br>
