...
require("../common/common.inc"); common_header(); ?>
	...
	<p CLASS="bgblack">J.P. Lewis</p>

	<p CLASS="bgwhite" ALIGN="JUSTIFY">
	<img SRC="/past/2002/images/speakers/lewis.jpg" WIDTH="150" HEIGHT="200"
		ALIGN="LEFT" hspace="10" BORDER="0" ALT="J. P. Lewis">
	...
	commercial graphics packages.<br><br>
	...
	with Linux since 1996.<br><br>

	<i>J. P. Lewis's talk is about "Graphics in Linux"</i><br><br>
