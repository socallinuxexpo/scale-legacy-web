...
require("../common/common.inc"); common_header(); ?>
	...
	<p CLASS="bgblack">Bill Hilf</p>

	<p CLASS="bgwhite" ALIGN="JUSTIFY">
	<img SRC="/past/2002/images/speakers/hilf.jpg" WIDTH="150" HEIGHT="200"
		ALIGN="RIGHT" hspace="10" BORDER="0" ALT="Bill Hilf">
	...
	for over seven years.<br><br>

	Prior to joining IBM, Bill has worked as the Sr. Director of Engineering
	for eToys, and as an architect for CNET's sites, such as News.com.<br><br>
	...
	Fullerton Unix and Linux educational programs.<br><br>
	
	<i>Bill Hilf will be delivering a speech on "IBM Linux Strategy - How IBM
	is contributing, investing, selling, using, and propelling Linux today.
	How IBM is using Linux in small-to-medium size enterprises."</i><br><br>
