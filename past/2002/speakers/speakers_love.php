...
require("../common/common.inc"); common_header(); ?>
	...
	<p CLASS="bgblack">Robert Love</p>

	<p CLASS="bgwhite" ALIGN="JUSTIFY">
	<img SRC="/past/2002/images/speakers/rml.jpg" WIDTH="150" HEIGHT="200"
		ALIGN="RIGHT" hspace="10" BORDER="0" ALT="Robert Love">
	...
	MontaVista Software, where he is paid to hack the kernel.<br><br>
	...
	<i>Robert Love is speaking about "What's new in the 2.5 kernel"</i><br><br>
	...
	reverse-mapping VM, and thread enhancements.<br><br>
	...
	what on earth will be its version (2.6 or 3.0)?<br><br>
	</p>
