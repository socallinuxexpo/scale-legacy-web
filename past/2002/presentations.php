...
require("common/common.inc"); common_header(); ?>
	...
	<p CLASS="bgwhite">
	The following videos were recorded by the
	<a HREF="http://www.lpbn.org/">Linux Public Broadcasting Network</a> at
	the first annual Southern California Linux Expo.
	</p>

	<p CLASS="bgblack">Dan Kegel Presents: Linux In Universities</p>
	...
	recognition of its increased importance.<br>
	-Video by Raymond Steding<br><br>
	<a HREF="http://stream.lpbn.org:8080/ramgen/scale2002-dankegel.rm">
	[Video]</a>
	<a HREF="http://www.kegel.com/linux/edu/">[Notes]</a>
	<a HREF="speakers/speakers_kegel.php">[Bio]</a>
	</p>

	<p CLASS="bgblack">Rasmus Lerdorf Presents: PHP - Scripting the Web</p>
	...
	scripting.<br>
	-Video by Renu Bora<br><br>
	<a HREF="http://stream.lpbn.org:8080/ramgen/scale2002-rasmuslerdorf.rm">
	[Video]</a>
	<a HREF="http://lerdorf.com/socal.pdf">[Notes]</a>
	<a HREF="speakers/speakers_lerdorf.php">[Bio]</a>
	</p>

	<p CLASS="bgblack">J. P. Lewis Presents: Graphics in Linux</p>
	...
	commercial graphics packages. J.P's talk is about Graphics in Linux<br>
	-Video by Benjamin Wade<br><br>
	<a HREF="http://stream.lpbn.org:8080/ramgen/scale2002-jplewis.rm">
	[Video]</a>
	<a HREF="speakers/speakers_lewis.php">[Bio]</a>
	</p>

	<p CLASS="bgblack">Zak Greant Presents: Perils of Open/Free Licensing in a
	Proprietary World</p>
	...
	to keep them at bay. Zak discusses Open/Free licensing issues<br>
	-Video by Clay Claiborne<br><br>
	<a HREF="http://stream.lpbn.org:8080/ramgen/scale2002-zakgreant.rm">
	[Video]</a>
	<a HREF="speakers/speakers_greant.php">[Bio]</a>
	</p>

	<p CLASS="bgblack">Robert Love Presents: What's New in the 2.5 Kernel?</p>
	...
	VM, and thread enhancements.<br>
	-Video by Benjamin Wade<br><br>
	<a HREF="http://stream.lpbn.org:8080/ramgen/scale2002-robertlove.rm">
	[Video]</a>
	<a HREF="presentations/rml_talk.ps">[Notes]</a>
	<a HREF="speakers/speakers_love.php">[Bio]</a>
	</p>

	<p CLASS="bgblack">Bill Hilf Presents: IBM's Linux Strategy</p>
	...
	and solutions<br>
	-Video by Renu Bora<br><br>
	<a HREF="http://stream.lpbn.org:8080/ramgen/scale2002-billhilf.rm">
	[Video]</a>
	<a HREF="presentations/IBM_Linux_SCALE2002_Hilf_conv.pdf">[Notes]</a>
	<a HREF="speakers/speakers_hilf.php">[Bio]</a>
	</p>

	<p CLASS="bgblack">Darren Moffat Presents: Administering Solaris and Linux
	Securely</p>
	...
	features of Solaris and Linux<br>
	-Video by Benjamin Wade<br><br>
	<a HREF="http://stream.lpbn.org:8080/ramgen/scale2002-darrenmoffat.rm">
	[Video]</a>
	<a HREF="speakers/speakers_moffat.php">[Bio]</a>
	</p>

	<p CLASS="bgblack">Tim Jones of the Tolis Group Presents: Backup and
	Recovery</p>
	...
	disaster recovery plan centered around Linux<br>
	-Video by Renu Bora<br><br>
	<a HREF="http://stream.lpbn.org:8080/ramgen/scale2002-backupandrecovery.rm">
	[Video]</a>
	<a HREF="speakers/speakers_jones.php">[Bio]</a>
	</p>

	<p CLASS="bgblack">Patrick Mochel Presents: All About Driverfs</p>
	...
	emphasis on the accompanying driverfs implementation and its benefits.<br>
	-Video by Renu Bora<br><br>
	<a HREF="http://stream.lpbn.org:8080/ramgen/scale2002-patrickmochel.rm">
	[Video]</a>
	<a HREF="presentations/pat_talk.ps">[Notes]</a>
	<a HREF="speakers/speakers_mochel.php">[Bio]</a>
	</p>

	<p CLASS="bgblack">Southern California Linux Expo: Panel Discussion</p>
	...
	of Debian Linux.<br><br>
	<a HREF="http://stream.lpbn.org:8080/ramgen/scale2002-panelsession.rm">
	[Video]</a>
	<a HREF="speakers/speakers_hamilton.php">
	[Bio - Marc Hamilton]</a>
	<a HREF="speakers/speakers_clark.php">
	[Bio - Jay Clark]</a>
	<a HREF="speakers/speakers_morales.php">
